...
public class MenuFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Change text depending on whether or not there is a game in progress
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mainViewModel.getGameInProgress()) {
                    mainViewModel.setStartGameCoordinate(3); // If game in progress, go straight to game
                } else {
                    mainViewModel.setStartGameCoordinate(1); // If not, go to player select
                }
            }
        });
